...
<template>
          ...
          <div class="project-list">
            <div v-for="project in userProjects" :key="project.id" class="project-item">
              ...
              <div class="project-actions">
                ...
                <button @click="handleDuplicateProject(project.id)" class="btn-small">
                  Duplicate
                </button>
                <button @click="handleDeleteProject(project.id)" class="btn-small btn-danger">
                  Delete
                </button>
              </div>
            </div>

            <div v-if="userProjects.length === 0" class="empty-state">No custom projects</div>
          </div>
  ...
  <!-- 项目编辑器 -->
  <ProjectEditor v-model:show="showProjectEditor" :project="editingProject" />
</template>
